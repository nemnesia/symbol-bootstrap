...
import { Wizard } from '../../src/commands/wizard/index.js';
import {
  Assembly,
  Constants,
  CustomPreset,
...
describe('Wizard', () => {
  ...
  it('Provide private keys', async () => {
    ...
    expect(customPreset).deep.equal(expectedCustomPreset);
  });
  ...
  it('Enables native SSL support on rest-gateway', async () => {
    ...
    StdUtils.in([
      ...
      'myhostname.org\n',
      './test-fixtures/certificates/restSsl.key\n',
      './test-fixtures/certificates/restSsl.crt\n',
      'myfriendlyname\n',
      '\n',
      'y\n',
      // '\n',
