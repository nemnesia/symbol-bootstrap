...
describe('ReportService', () => {
  const assertReport = async (
    ...
    const expectedReportFolder = `./test-fixtures/reports/${expectedReportsFolder}`;
...
`,
      ).toEqual(expectedReport.trim());
    });

    for (const gateway of configResult.presetData.gateways || []) {
      const currentRestJsonFile = fileSystemService.getTargetGatewayFolder(
        params.target,
        true,
        gateway.name,
        'rest.json',
...
`,
  ...
  it('ReportService testnet dual voting report', async () => {
    const target = 'target/test-output/ReportService.testnet.voting.report';
  ...
  it('ReportService testnet peer voting report', async () => {
    const target = 'target/test-output/ReportService.testnet.peer.voting.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'ABC',
      nodes: [
  ...
  it('ReportService testnet peer voting non harvesting report', async () => {
    const target = 'target/test-output/ReportService.testnet.peer.non.harvesting.voting.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
      nodes: [
  ...
  it('ReportService testnet api', async () => {
    const target = 'target/test-output/ReportService.testnet.api.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'ABC',
      nodes: [
  ...
  it('ReportService mainnet peer', async () => {
    const target = 'target/test-output/ReportService.mainnet.peer.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
      nodes: [
  ...
  it('ReportService mainnet dual', async () => {
    const target = 'target/test-output/ReportService.mainnet.dual.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
      nodes: [
  ...
  it('ReportService mainnet dual voting', async () => {
    const target = 'target/test-output/ReportService.mainnet.dual.voting.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
      nodes: [
  ...
  it('ReportService bootstrap report', async () => {
    const target = 'target/test-output/ReportService.bootstrap.voting.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
  ...
  it('ReportService custom network dual', async () => {
    const target = 'target/test-output/ReportService.customNetwork.dual.report';
    const customPresetObject: CustomPreset = {
      restDeploymentToolLastUpdatedDate: '2021-05-23',
      restDeploymentToolVersion: 'abc',
      nodes: [
    ...
    const params = {
      ...ConfigService.defaultParams,
      upgrade: true,
      workingDir: 'test-fixtures/customNetwork',
