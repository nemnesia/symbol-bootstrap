...
import { LoggerFactory, LogType } from '../../src/index.js';
import {
  GenericNodeAccount,
  KeyAccount,
...
describe('LinkTransactionGenericFactory', () => {
  ...
  const remoteTransactionFactory = (account: KeyAccount, action: LinkAction) => ({
    ...account,
    action,
    name: 'remote',
  });
  const vrfTransactionFactory = (account: KeyAccount, action: LinkAction) => ({
    ...account,
    action,
    name: 'vrf',
  });
  const votingKeyTransactionFactory = (account: VotingKeyAccount, action: LinkAction) => ({
    ...account,
    action,
    name: 'voting',
  });
